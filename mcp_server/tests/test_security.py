...
class TestMcpSecurity(common.TransactionCase):
    ...
    def test_settings_menu_access(self):
        ...
        self.assertIn(mcp_admin_group, menu_root.groups_id, "Menu should be restricted to MCP Admin group")
        ...
        self.assertNotIn(
            mcp_user_group, menu_root.groups_id, "Menu should NOT be directly accessible to MCP User group"
        )
