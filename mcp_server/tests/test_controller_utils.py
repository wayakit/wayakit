...
class TestMcpUtils(common.TransactionCase):
    ...
    def setUp(self):
        ...
        self.valid_api_key = env_as_user["res.users.apikeys"]._generate("rpc", "Test Utils API Key")
...
class TestAuthAndResponseUtils(common.TransactionCase):
    ...
    def setUp(self):
        ...
        env_as_user = self.env(user=self.test_user)
        self.valid_api_key = env_as_user["res.users.apikeys"]._generate("rpc", "Test Auth API Key")
